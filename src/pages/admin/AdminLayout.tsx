      ...
      <SidebarProvider>
        <div className="min-h-screen flex w-full bg-[#F8FAFC]">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            {!["/admin", "/admin/admins", "/admin/institucionais", "/admin/profissionais", "/admin/laudos", "/admin/tutorial", "/admin/tutoriais", "/admin/configuracoes"].includes(pathname) && <BarraFiltrosGlobais />}
