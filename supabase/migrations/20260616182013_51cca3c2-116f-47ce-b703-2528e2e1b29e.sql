...
REVOKE ALL ON FUNCTION public.seed_pacientes_teste_para_gestores() FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.seed_pacientes_teste_para_gestores() TO service_role;
