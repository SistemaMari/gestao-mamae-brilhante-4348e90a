...
export const EmailChangeEmail = ({ oldEmail, newEmail, confirmationUrl }: EmailChangeEmailProps) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme a alteração do seu e-mail no MARI</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={brand}>MARI</Heading>
        <Heading style={h1}>Confirme a alteração de e-mail</Heading>
        <Text style={text}>
          Você solicitou alterar o e-mail da sua conta no MARI | Inteligência Clínica de{' '}
        ...
        <Text style={footer}>
          Se você não solicitou esta alteração, recomendamos proteger sua conta imediatamente.
        </Text>
      </Container>
    </Body>
  </Html>
